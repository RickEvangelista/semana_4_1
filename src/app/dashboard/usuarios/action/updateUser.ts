...
import { UpdateUserFormData, userSchemaUpdate } from "../schemas/userSchema";
...
export async function updateUser(
    ...
    const { nome_completo, cpf, email, senha, perfil } = validateData.data as UpdateUserFormData;
    ...
    try {
        ...
        if(!userProfile) return {success: false, message: "Perfil não encontrado"}
